          ...
          <div className="w-3/5 h-full">
            ...
            <div className="pt-2 mt-2">
              ...
              <div className="mt-1 flex flex-col gap-3 text-ex-small mx-4">
                <a href='http' className="flex items-center"><span><FaUser className="inline mr-4 text-sm mt-2" /> 12345 78946</span></a>

                <a href='http' className="flex items-center"><span><FaTwitter className="inline mr-4 text-sm" /> @theditiarora</span></a>

                <a href='http' className="flex items-center"><span><HiMail className="inline mr-4 text-sm" /> diti.aromatic@gmail.com</span></a>
